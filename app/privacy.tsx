...
const sections = [
  {
    title: '取得する情報',
    body:
      '本の間は、アカウント情報、蔵書情報、欲しい漫画情報、通知情報、ランキング集計に必要な匿名集計値、シリーズ名の読み方報告、アプリ設定を保存または利用する場合があります。',
  },
  {
    title: '利用目的',
    body:
      '蔵書・シリーズ・巻抜けの管理、ISBN検索、表紙画像URLの取得、欲しい漫画リスト、新刊通知、ランキング表示、シリーズ名の読み方補正、アカウント管理、不具合調査のために利用します。',
  },
  {
    title: 'ランキング',
    body:
